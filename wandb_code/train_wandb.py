...
def parse_args():
    ...
    parser.add_argument('--wandb_project', type=str, default='OCR-EAST')
...
def do_training(data_dir, model_dir, device, image_size, input_size, num_workers, batch_size,
                learning_rate, max_epoch, save_interval, wandb_project, wandb_entity, wandb_run_name):
...
#python train.py --wandb_project "your-project" --wandb_entity "your-username" --wandb_run_name "experiment-1"
